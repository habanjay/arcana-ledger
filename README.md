...
- **📊 Trade Tracking**  
  Log trades, positions, and performance over time.

- **📈 Portfolio Analytics**  
  Visualize gains, losses, and trends with clean, responsive charts.

- **📰 Market News Integration**  
  Pull in relevant stock or crypto news (API‑based).
...
### Installation
```bash
git clone https://github.com/habanjay/arcana-ledger.git
cd arcana-ledger
npm install
